...
/**
 * The routes registered on one HTTP method, and what the {@link PathMatcher} of that method is built from.
 * A builder holds one per method; the help endpoint walks them to describe the api.
 */
