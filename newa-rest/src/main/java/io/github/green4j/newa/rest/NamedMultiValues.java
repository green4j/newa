...
/**
 * {@link NamedValues} where one name may carry several values - a query string or a form, where
 * {@code ?id=1&id=2} is one name and two values. The inherited single-value readers answer with the first
 * of them.
 */
