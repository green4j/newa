...
/**
 * The {@link FullHttpResponseContent} to use unless there is a reason not to: it holds a reference to what
 * it was given and copies nothing until the response is written. One per response, or one reused by a
 * handler which answers on a single thread.
 */
